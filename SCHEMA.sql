...
\restrict yKetAjJ5yXtf9Iu0RLbBPAHups9LEy1xKoYQbvceZIHrpkK2ZXnY3MApRKi83WP
...
CREATE TABLE public.activity_log (
    ...
    is_email_action boolean DEFAULT false NOT NULL
);
...
--
-- Name: authorized_email_senders; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.authorized_email_senders (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    builder_id uuid NOT NULL,
    project_id uuid,
    email character varying(255) NOT NULL,
    name character varying(255),
    role character varying(50) DEFAULT 'external'::character varying NOT NULL,
    permissions jsonb DEFAULT '["add_invoice", "add_document"]'::jsonb NOT NULL,
    is_active boolean DEFAULT true NOT NULL,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    deleted_at timestamp with time zone
...
--
-- Name: COLUMN authorized_email_senders.role; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.authorized_email_senders.role IS 'external|contractor|client';


--
-- Name: COLUMN authorized_email_senders.permissions; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.authorized_email_senders.permissions IS 'Array of allowed actions: add_invoice, add_document, add_payment, add_note';
...
--
-- Name: TABLE budget_category_benchmarks; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TABLE public.budget_category_benchmarks IS 'Expected budget percentages per category by construction type';
...
--
-- Name: TABLE builder_benchmarks; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TABLE public.builder_benchmarks IS 'Learned benchmarks from builder project history';


--
-- Name: COLUMN builder_benchmarks.confidence_level; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.builder_benchmarks.confidence_level IS 'Based on sample_count: low (<3), medium (3-9), high (>=10)';


--
-- Name: COLUMN builder_benchmarks.blend_weight; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.builder_benchmarks.blend_weight IS '0 = use industry benchmarks, 1 = use builder benchmarks only';
...
COMMENT ON COLUMN public.documents.metadata IS 'AI-extracted document data: amount, vendor, invoiceNumber, isPaid, paidAmount, etc.';


--
-- Name: email_action_results; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.email_action_results (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    email_action_id uuid NOT NULL,
    builder_id uuid NOT NULL,
...
--
-- Name: COLUMN email_action_results.action_type; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.email_action_results.action_type IS 'create_invoice|create_payment|create_document|update_task|update_budget|complete_task|mark_milestone|add_note|delete_invoice|update_invoice';


--
-- Name: COLUMN email_action_results.entity_type; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.email_action_results.entity_type IS 'invoice|payment|document|task|budget_item|milestone|activity_log';


--
-- Name: COLUMN email_action_results.status; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.email_action_results.status IS 'pending|success|failed|undone';
...
CREATE TABLE public.email_actions (
    ...
    body_html text,
    raw_email jsonb,
    email_type character varying(50) DEFAULT 'unknown'::character varying NOT NULL,
    parsed_intent character varying(100),
...
--
-- Name: COLUMN email_actions.email_type; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.email_actions.email_type IS 'explicit_instruction|forwarded_attachment|forwarded_receipt|forwarded_link|mixed|correction|unknown';


--
-- Name: COLUMN email_actions.status; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.email_actions.status IS 'pending|processing|executed|failed|rejected';


--
-- Name: COLUMN email_actions.review_status; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.email_actions.review_status IS 'approved|rejected';
...
--
-- Name: TABLE industry_benchmarks; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TABLE public.industry_benchmarks IS 'Industry standard benchmarks for residential construction phases';


--
-- Name: COLUMN industry_benchmarks.unit_type; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.industry_benchmarks.unit_type IS 'Type of construction: single_family, townhomes, condos, multifamily';


--
-- Name: COLUMN industry_benchmarks.metric_type; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.industry_benchmarks.metric_type IS 'Type of metric: duration_days or cost_percent';
...
--
-- Name: jostin_email_threads; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.jostin_email_threads (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    builder_id uuid NOT NULL,
    user_id uuid NOT NULL,
    conversation_id uuid NOT NULL,
...
--
-- Name: project_email_addresses; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.project_email_addresses (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    builder_id uuid NOT NULL,
    project_id uuid NOT NULL,
    email_prefix character varying(100) NOT NULL,
    is_active boolean DEFAULT true NOT NULL,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    deleted_at timestamp with time zone
...
--
-- Name: TABLE project_outcomes; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TABLE public.project_outcomes IS 'Final metrics from completed projects for benchmark learning';


--
-- Name: COLUMN project_outcomes.phase_outcomes; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.project_outcomes.phase_outcomes IS 'JSON array of phase duration data';


--
-- Name: COLUMN project_outcomes.category_outcomes; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.project_outcomes.category_outcomes IS 'JSON array of budget category data';
...
--
-- Name: TABLE project_risk_metrics; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TABLE public.project_risk_metrics IS 'Calculated risk scores and metrics per project';


--
-- Name: COLUMN project_risk_metrics.risk_level; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.project_risk_metrics.risk_level IS 'low (<25), medium (25-49), high (50-74), critical (>=75)';
...
--
-- Name: COLUMN projects.purchase_price; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.projects.purchase_price IS 'Property purchase price in dollars';


--
-- Name: COLUMN projects.appraised_value; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.projects.appraised_value IS 'Current appraised value per unit';


--
-- Name: COLUMN projects.target_arv; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.projects.target_arv IS 'Original target ARV per unit set at project start';


--
-- Name: COLUMN projects.valuation_date; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.projects.valuation_date IS 'Date of the most recent appraisal';


--
-- Name: COLUMN projects.appraisal_document_id; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.projects.appraisal_document_id IS 'Reference to uploaded appraisal document';


--
-- Name: COLUMN projects.predicted_arv; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.projects.predicted_arv IS 'Forecasted ARV per unit at project completion';
...
--
-- Name: TABLE risk_interventions; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TABLE public.risk_interventions IS 'Prioritized action items for risk mitigation';


--
-- Name: COLUMN risk_interventions.priority_rank; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.risk_interventions.priority_rank IS 'Lower number = higher priority (1 is most urgent)';
...
--
-- Name: COLUMN schedule_milestones.task_id; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.schedule_milestones.task_id IS 'Optional linked task - when set, milestone status is auto-calculated based on task completion';
...
--
-- Name: COLUMN schedule_tasks.duration_days; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.schedule_tasks.duration_days IS 'Task duration in days. When set, planned_end_date = planned_start_date + duration_days - 1';


--
-- Name: COLUMN schedule_tasks.predecessor_task_id; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.schedule_tasks.predecessor_task_id IS 'Most important predecessor task - single dependency replacing many-to-many';
...
--
-- Name: authorized_email_senders authorized_email_senders_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.authorized_email_senders
    ADD CONSTRAINT authorized_email_senders_pkey PRIMARY KEY (id);
...
--
-- Name: email_action_results email_action_results_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.email_action_results
    ADD CONSTRAINT email_action_results_pkey PRIMARY KEY (id);
...
--
-- Name: jostin_email_threads jostin_email_threads_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.jostin_email_threads
    ADD CONSTRAINT jostin_email_threads_pkey PRIMARY KEY (id);
...
--
-- Name: project_email_addresses project_email_addresses_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.project_email_addresses
    ADD CONSTRAINT project_email_addresses_pkey PRIMARY KEY (id);
...
--
-- Name: idx_activity_log_email_action_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_activity_log_email_action_id ON public.activity_log USING btree (email_action_id) WHERE (email_action_id IS NOT NULL);
...
--
-- Name: idx_activity_log_is_email_action; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_activity_log_is_email_action ON public.activity_log USING btree (is_email_action) WHERE (is_email_action = true);
...
--
-- Name: idx_authorized_email_senders_active; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_authorized_email_senders_active ON public.authorized_email_senders USING btree (is_active) WHERE ((is_active = true) AND (deleted_at IS NULL));


--
-- Name: idx_authorized_email_senders_builder_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_authorized_email_senders_builder_id ON public.authorized_email_senders USING btree (builder_id);


--
-- Name: idx_authorized_email_senders_deleted_at; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_authorized_email_senders_deleted_at ON public.authorized_email_senders USING btree (deleted_at) WHERE (deleted_at IS NULL);


--
-- Name: idx_authorized_email_senders_email; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_authorized_email_senders_email ON public.authorized_email_senders USING btree (email);


--
-- Name: idx_authorized_email_senders_email_project; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX idx_authorized_email_senders_email_project ON public.authorized_email_senders USING btree (builder_id, COALESCE(project_id, '00000000-0000-0000-0000-000000000000'::uuid), email) WHERE (deleted_at IS NULL);


--
-- Name: idx_authorized_email_senders_project_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_authorized_email_senders_project_id ON public.authorized_email_senders USING btree (project_id) WHERE (project_id IS NOT NULL);
...
--
-- Name: idx_email_action_results_builder_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_email_action_results_builder_id ON public.email_action_results USING btree (builder_id);


--
-- Name: idx_email_action_results_email_action_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_email_action_results_email_action_id ON public.email_action_results USING btree (email_action_id);


--
-- Name: idx_email_action_results_entity; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_email_action_results_entity ON public.email_action_results USING btree (entity_type, entity_id) WHERE (entity_id IS NOT NULL);


--
-- Name: idx_email_action_results_status; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_email_action_results_status ON public.email_action_results USING btree (status);


--
-- Name: idx_email_actions_builder_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_email_actions_builder_id ON public.email_actions USING btree (builder_id);


--
-- Name: idx_email_actions_created_at; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_email_actions_created_at ON public.email_actions USING btree (created_at);


--
-- Name: idx_email_actions_deleted_at; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_email_actions_deleted_at ON public.email_actions USING btree (deleted_at) WHERE (deleted_at IS NULL);


--
-- Name: idx_email_actions_in_reply_to; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_email_actions_in_reply_to ON public.email_actions USING btree (in_reply_to) WHERE (in_reply_to IS NOT NULL);


--
-- Name: idx_email_actions_message_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_email_actions_message_id ON public.email_actions USING btree (message_id) WHERE (message_id IS NOT NULL);


--
-- Name: idx_email_actions_parent_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_email_actions_parent_id ON public.email_actions USING btree (parent_email_action_id) WHERE (parent_email_action_id IS NOT NULL);


--
-- Name: idx_email_actions_project_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_email_actions_project_id ON public.email_actions USING btree (project_id);


--
-- Name: idx_email_actions_requires_review; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_email_actions_requires_review ON public.email_actions USING btree (requires_review) WHERE ((requires_review = true) AND (deleted_at IS NULL));


--
-- Name: idx_email_actions_sender_email; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_email_actions_sender_email ON public.email_actions USING btree (sender_email);


--
-- Name: idx_email_actions_sender_user_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_email_actions_sender_user_id ON public.email_actions USING btree (sender_user_id);
...
--
-- Name: idx_email_actions_thread_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_email_actions_thread_id ON public.email_actions USING btree (thread_id) WHERE (thread_id IS NOT NULL);
...
--
-- Name: idx_jostin_threads_conversation; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX idx_jostin_threads_conversation ON public.jostin_email_threads USING btree (conversation_id);


--
-- Name: idx_jostin_threads_message_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_jostin_threads_message_id ON public.jostin_email_threads USING btree (last_email_message_id);
...
--
-- Name: idx_project_email_addresses_active; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_project_email_addresses_active ON public.project_email_addresses USING btree (is_active) WHERE ((deleted_at IS NULL) AND (is_active = true));


--
-- Name: idx_project_email_addresses_builder_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_project_email_addresses_builder_id ON public.project_email_addresses USING btree (builder_id);


--
-- Name: idx_project_email_addresses_email_prefix; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX idx_project_email_addresses_email_prefix ON public.project_email_addresses USING btree (email_prefix) WHERE (deleted_at IS NULL);


--
-- Name: idx_project_email_addresses_project_id; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX idx_project_email_addresses_project_id ON public.project_email_addresses USING btree (project_id) WHERE (deleted_at IS NULL);
...
CREATE TRIGGER trg_documents_search BEFORE INSERT OR UPDATE OF name, description, extracted_text ON public.documents FOR EACH ROW EXECUTE FUNCTION public.documents_search_trigger();
...
--
-- Name: activity_log activity_log_email_action_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.activity_log
    ADD CONSTRAINT activity_log_email_action_id_fkey FOREIGN KEY (email_action_id) REFERENCES public.email_actions(id);
...
--
-- Name: authorized_email_senders authorized_email_senders_builder_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.authorized_email_senders
    ADD CONSTRAINT authorized_email_senders_builder_id_fkey FOREIGN KEY (builder_id) REFERENCES public.builders(id);


--
-- Name: authorized_email_senders authorized_email_senders_project_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.authorized_email_senders
    ADD CONSTRAINT authorized_email_senders_project_id_fkey FOREIGN KEY (project_id) REFERENCES public.projects(id) ON DELETE CASCADE;
...
--
-- Name: email_action_results email_action_results_builder_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.email_action_results
    ADD CONSTRAINT email_action_results_builder_id_fkey FOREIGN KEY (builder_id) REFERENCES public.builders(id);


--
-- Name: email_action_results email_action_results_email_action_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.email_action_results
    ADD CONSTRAINT email_action_results_email_action_id_fkey FOREIGN KEY (email_action_id) REFERENCES public.email_actions(id) ON DELETE CASCADE;


--
-- Name: email_actions email_actions_builder_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.email_actions
    ADD CONSTRAINT email_actions_builder_id_fkey FOREIGN KEY (builder_id) REFERENCES public.builders(id);


--
-- Name: email_actions email_actions_parent_email_action_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.email_actions
    ADD CONSTRAINT email_actions_parent_email_action_id_fkey FOREIGN KEY (parent_email_action_id) REFERENCES public.email_actions(id);


--
-- Name: email_actions email_actions_project_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.email_actions
    ADD CONSTRAINT email_actions_project_id_fkey FOREIGN KEY (project_id) REFERENCES public.projects(id) ON DELETE CASCADE;


--
-- Name: email_actions email_actions_reviewed_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.email_actions
    ADD CONSTRAINT email_actions_reviewed_by_fkey FOREIGN KEY (reviewed_by) REFERENCES public.users(id);


--
-- Name: email_actions email_actions_sender_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.email_actions
    ADD CONSTRAINT email_actions_sender_user_id_fkey FOREIGN KEY (sender_user_id) REFERENCES public.users(id);


--
-- Name: email_actions email_actions_undone_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.email_actions
    ADD CONSTRAINT email_actions_undone_by_fkey FOREIGN KEY (undone_by) REFERENCES public.users(id);
...
--
-- Name: jostin_email_threads jostin_email_threads_builder_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.jostin_email_threads
    ADD CONSTRAINT jostin_email_threads_builder_id_fkey FOREIGN KEY (builder_id) REFERENCES public.builders(id);


--
-- Name: jostin_email_threads jostin_email_threads_conversation_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.jostin_email_threads
    ADD CONSTRAINT jostin_email_threads_conversation_id_fkey FOREIGN KEY (conversation_id) REFERENCES public.ai_conversations(id);


--
-- Name: jostin_email_threads jostin_email_threads_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.jostin_email_threads
    ADD CONSTRAINT jostin_email_threads_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id);
...
--
-- Name: project_email_addresses project_email_addresses_builder_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.project_email_addresses
    ADD CONSTRAINT project_email_addresses_builder_id_fkey FOREIGN KEY (builder_id) REFERENCES public.builders(id);


--
-- Name: project_email_addresses project_email_addresses_project_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.project_email_addresses
    ADD CONSTRAINT project_email_addresses_project_id_fkey FOREIGN KEY (project_id) REFERENCES public.projects(id) ON DELETE CASCADE;
...
\unrestrict yKetAjJ5yXtf9Iu0RLbBPAHups9LEy1xKoYQbvceZIHrpkK2ZXnY3MApRKi83WP
